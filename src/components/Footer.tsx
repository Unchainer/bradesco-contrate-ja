        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-display font-bold text-primary-foreground">Renifer J. Ferreira</span>
            </div>
            <p className="text-sm">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>WhatsApp: (27) 99975-9155</li>
              <li>Email: contato@reniferferreira.com.br</li>
            </ul>
          </div>
        </div>
